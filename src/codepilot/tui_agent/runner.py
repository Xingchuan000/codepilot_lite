        ...
        try:
            ...
            self.session = self.session_store.append_run(
                ...
                TUISessionRunRef(
                    ...
                    assistant_stop_reason=result.assistant_stop_reason,
                    delivery_kind=result.delivery_kind,
                    requires_evidence=result.requires_evidence,
                    evidence_reasons=tuple(result.evidence_reasons),
                    ...
                    tests_required=result.tests_required,
                    diff_required=result.diff_required,
                    diff_checked=result.diff_checked,
            ...
            self.event_stream.publish(
                TUIEvent(
                    ...
                    payload={
                        ...
                        "delivery_kind": result.delivery_kind,
                        "requires_evidence": result.requires_evidence,
                        "evidence_reasons": list(result.evidence_reasons),
                        "write_attempted": result.write_attempted,
                        "write_executed": result.write_executed,
                        "written_files": list(result.written_files),
                        "observed_changed_files": list(result.observed_changed_files),
                        "claimed_changed_files": list(result.claimed_changed_files),
                        "tests_required": result.tests_required,
                        "diff_required": result.diff_required,
                        "diff_checked": result.diff_checked,
