...
6. `codepilot agent-run "Use MCP to read README and summarize it" --repo . --fake-responses examples/mcp/fake_responses_mcp_read_file.jsonl --mcp-config examples/mcp/fake_filesystem_mcp.json --approve`
